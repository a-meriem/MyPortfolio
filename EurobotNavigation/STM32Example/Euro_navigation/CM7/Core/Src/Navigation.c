...
double Nav_XYTargets_ad[5][4] = {{0.0}};
...
void Nav_vNavigatorInit()
{
	...
	//	Nav_CurrentX_mm_d = 1125.0 ;
	//	Nav_CurrentY_mm_d = 225.0 ;
	//	Nav_CurrentAngle_rad_d	= 1.0 * M_PI ;
	//	Nav_CurrentAngle_deg_d = 180 ;
	//	Nav_CurrentTargetAngle_deg_d = 180 ;
